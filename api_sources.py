...
# Версия с увеличенным таймаутом до 1200 секунд
...
class APISourceManager:
    ...
    С увеличенным таймаутом до 1200 секунд
    """
    ...
    async def fetch_district_data(self, district: str) -> List[Dict]:
        ...
        for settlement in settlements:
            try:
                elapsed = time.time() - self.start_time
                if elapsed > 1150:  # Увеличено до 1150 секунд
        ...
        if all_villages:
            ...
            if villages_without_coords:
                ...
                for i, village in enumerate(sorted_villages):
                    try:
                        elapsed = time.time() - self.start_time
                        if elapsed > 1180:  # Увеличено до 1180 секунд (оставляем запас 20 секунд)
